  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Curso Audaces completo: aprenda Audaces, modelagem digital, costura e costura criativa profissional. Curso Audaces com moldes em PDF, Audaces encaixe, Audaces Digiflash. Mais de 500 alunos formados. O melhor curso de modelagem do Brasil." />
        <meta name="keywords" content="Audaces, curso Audaces, cursos de modelagem, curso de modelagem, costura, costura profissional, modelagem digital, moldes em PDF, Audaces encaixe, Audaces Digiflash, Audaces software, aprender Audaces, Audaces 7, Audaces grátis, baixar Audaces, download Audaces, moldes digitais, corte e costura, alta costura, costura criativa, modelagem Audaces, operador Audaces, curso de costura, curso de costura criativa, aprender costura, curso audaces online" />
